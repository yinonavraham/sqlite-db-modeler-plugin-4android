 ...
 * <ul>
 *   <li>{@link org.ynn.sqlitedb.modeler.model.column.impl.IndexedColumnImpl#getColumn <em>Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IndexedColumnImpl extends MinimalEObjectImpl.Container implements IndexedColumn {
	...
	protected EClass eStaticClass() {
		return ColumnPackage.Literals.INDEXED_COLUMN;
	}
		...
		if (column != null && column.eIsProxy()) {
			...
			if (column != oldColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ColumnPackage.INDEXED_COLUMN__COLUMN, oldColumn, column));
			}
		}
		return column;
	}
	...
	public void setColumn(Column newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ColumnPackage.INDEXED_COLUMN__COLUMN, oldColumn, column));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ColumnPackage.INDEXED_COLUMN__COLUMN:
